...
; Pallet Town events
	...
	const EVENT_GOT_MON_FROM_BROCK
	const EVENT_GOT_MON_FROM_MISTY
	const EVENT_GOT_MON_FROM_SURGE
	const EVENT_GOT_MON_FROM_ERIKA
	const EVENT_GOT_MON_FROM_KOGA
	const EVENT_GOT_MON_FROM_BLAINE
	const EVENT_GOT_MON_FROM_SABRINA
	const EVENT_GOT_MON_FROM_GIOVANNI
	const_skip 9
